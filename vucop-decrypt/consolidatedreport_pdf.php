...
if(isset($_REQUEST['ddlBranchName'])&&!empty($_REQUEST['ddlBranchName']))
{
    ...
    //$sql = "(select id,cps_unique_req, cps_micr_code,cps_account_no,cps_act_name,cps_act_jointname1,cps_no_of_books,cps_book_size,cps_chq_no_from,cps_chq_no_to,cps_date,cps_tr_code,cps_process_user_id from tb_print_req_collection where cps_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchString." ORDER BY cps_micr_code ASC,cps_tr_code ASC,cps_date ASC)";

     $sql = "select id,cps_unique_req, cps_micr_code,cps_account_no,cps_act_name,cps_act_jointname1,cps_no_of_books,cps_book_size,cps_chq_no_from,cps_chq_no_to,cps_date,cps_tr_code,cps_process_user_id from tb_print_req_collection where cps_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchString." ORDER BY ABS(cps_micr_code) ASC,ABS(cps_tr_code) ASC,cps_date ASC, id ASC";
...
if($resultbranch = $db->get_results($sqlbranch)){
  ...
  foreach ($resultbranch as $rowbranch) {
           ...
           // $sql = "(select id,cps_unique_req, cps_micr_code,cps_account_no,cps_act_name,cps_act_jointname1,cps_no_of_books,cps_book_size,cps_chq_no_from,cps_chq_no_to,cps_date,cps_tr_code,cps_process_user_id from tb_print_req_collection where cps_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchStringIndv." ORDER BY cps_tr_code ASC,cps_date ASC)";
            ...
            $sql = "select id,cps_unique_req, cps_micr_code,cps_account_no,cps_act_name,cps_act_jointname1,cps_no_of_books,cps_book_size,cps_chq_no_from,cps_chq_no_to,cps_date,cps_tr_code,cps_process_user_id from tb_print_req_collection where cps_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchStringIndv." ORDER BY ABS(cps_micr_code) ASC,ABS(cps_tr_code) ASC,cps_date ASC, id ASC";
