					...
					<tr>
						...
						<td align="left" valign="top" width="80%">
							<label>
								...
								<select name="bankname" id="bankname" style="width:379px;" onchange="showBankCode(this.value)">
									<option value="860"> ISLAMPUR URBAN CO-OP BANK </option>
									<option value="818"> ISLAMPUR URBAN CO-OP BANK (Sangali) </option>
								</select>
							</label>
						</td>
					</tr>
