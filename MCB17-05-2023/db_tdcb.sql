...
(0001, 'THE THANE DIST. CENTRAL CO-OP BANK LTD', 524, 'SHIVAJIPATH', 'POST BOX 19', 'THANE (W)', 1, 1, 2, 2, '400601', '9320153064', '9320153064', 'BHARAT KHONA', '', 0, 0, '', '', 'tdcB.bank.org', 'a:1:{i:0;a:3:{i:0;s:26:"HP LaserJet 400 M401 PCL 6";i:1;s:6:"Tray 1";i:2;s:6:"Tray 2";}}');
...
CREATE TABLE IF NOT EXISTS `tb_branchdetails` (
  ...
  `branch_master_id` int(3) NOT NULL,
...
(001, 'THA001', 'THANE', 'THA', 1, 1, 1),
(002, 'MUM001', 'MUMBAI', 'MUM', 1, 1, 0),
(003, 'KAL001', 'KALYAN', 'KAL', 1, 1, 0);
...
(27, 0, 9, '2017-03-24'),
(28, 0, 294228, '2017-04-17'),
(29, 0, 0, '2017-04-17'),
(30, 0, 294228, '2017-04-17'),
(31, 0, 965, '2017-04-17');
...
(1, 10, 1, 19, 000001, 999999, 513701, 1),
(2, 11, 1, 19, 000001, 999999, 390501, 1);

-- --------------------------------------------------------

--
-- Table structure for table `tb_cps_dd`
--

CREATE TABLE IF NOT EXISTS `tb_cps_dd` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `dd_branch_id` int(200) NOT NULL,
...
--
-- Dumping data for table `tb_cps_dd`
--
...
--
-- Table structure for table `tb_cps_ddseries`
--

CREATE TABLE IF NOT EXISTS `tb_cps_ddseries` (
  `series_id` int(11) NOT NULL AUTO_INCREMENT,
  `series_bank_id` int(3) unsigned zerofill NOT NULL,
  `series_branch_id` int(3) NOT NULL,
...
--
-- Dumping data for table `tb_cps_ddseries`
--
...
--
-- Table structure for table `tb_cps_dd_reprintque`
--

CREATE TABLE IF NOT EXISTS `tb_cps_dd_reprintque` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `dd_branch_id` int(200) NOT NULL,
  `cps_chq_no_from` bigint(6) unsigned zerofill NOT NULL,
  `cps_chq_no_to` bigint(6) unsigned zerofill NOT NULL,
...
--
-- Dumping data for table `tb_cps_dd_reprintque`
--

INSERT INTO `tb_cps_dd_reprintque` (`id`, `dd_branch_id`, `cps_chq_no_from`, `cps_chq_no_to`, `cps_no_of_books`, `cps_book_size`, `cps_date`, `cps_process_user_id`, `cps_reprint_approved`) VALUES
(9, 14, 466001, 466001, 01, 001, '2017-01-09', 1, 0),
(10, 14, 466002, 466101, 01, 100, '2017-01-09', 1, 0),
(11, 14, 466102, 466201, 01, 100, '2017-01-09', 1, 0),
(12, 14, 466202, 466301, 01, 100, '2017-01-09', 1, 0),
(13, 7, 430801, 430900, 01, 100, '2017-01-23', 1, 0),
(14, 7, 430901, 431000, 01, 100, '2017-01-23', 1, 0),
(15, 7, 431001, 431100, 01, 100, '2017-01-23', 1, 0),
(16, 7, 431101, 431200, 01, 100, '2017-01-23', 1, 0),
(17, 7, 431201, 431300, 01, 100, '2017-01-23', 1, 0);
...
CREATE TABLE IF NOT EXISTS `tb_cps_payorder` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `pay_branch_id` int(200) NOT NULL,
  `cps_chq_no_from` bigint(6) unsigned zerofill NOT NULL,
  `cps_chq_no_to` bigint(6) unsigned zerofill NOT NULL,
  `cps_no_of_books` int(2) unsigned zerofill NOT NULL,
  `cps_book_size` int(3) unsigned zerofill NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_cps_payorderseries` (
  `series_id` int(11) NOT NULL AUTO_INCREMENT,
  `series_bank_id` int(3) unsigned zerofill NOT NULL,
  `series_branch_id` int(3) NOT NULL,
  `series_branch_code` int(3) unsigned zerofill NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_cps_payorder_reprintque` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `pay_branch_id` int(200) NOT NULL,
  `cps_chq_no_from` bigint(6) unsigned zerofill NOT NULL,
  `cps_chq_no_to` bigint(6) unsigned zerofill NOT NULL,
...
--
-- Dumping data for table `tb_cps_payorder_reprintque`
--
...
('', 'uploads/', 'Excel', '', '', 'Excel', '', '', 0, 1, 000000, 000000, 9, 365, 'THE THANE DIST. CENTRAL CO-OP. BANK LTD.   ', 'DevHarsh Infotech Pvt Ltd', 'Hydrangeas.jpg', 'Penguins.jpg', '', '', '', '', '', 360, '', '', '', '0000-00-00', 0, '0000-00-00', 0, 0, 0, 0);
...
--
-- Table structure for table `tb_dd_reprint_req_collection`
--

CREATE TABLE IF NOT EXISTS `tb_dd_reprint_req_collection` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `dd_branch_id` int(200) NOT NULL,
  `cps_chq_no_from` bigint(6) unsigned zerofill NOT NULL,
  `cps_chq_no_to` bigint(6) unsigned zerofill NOT NULL,
...
--
-- Dumping data for table `tb_dd_reprint_req_collection`
--
...
('admin', '0192023a7bbd73250516f069df18b500', '2012-04-21 00:00:00', 1, 0, 0, 1, 2, 'admin', '2017-02-14', 1),
('reprint', '965b21f9b0929eb034918f57a06065a8', '2017-04-17 00:00:00', 21, 0, 0, 1, 1, 'reprint', '2017-04-17', 1);
...
CREATE TABLE IF NOT EXISTS `tb_print_req_collection` (
  ...
  `cps_product_code` varchar(5) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cps_country` (`cps_country`),
  KEY `cps_emailid` (`cps_emailid`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=7 ;
...
(1, 00000022, 400524019, 019, '002500300030132', 'BHOIR NANDKUMAR RAMA', 01, 'Y', 001, 10, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', 513695, 513695, 030132, '2017-04-17', 1, 0, '', '', '', NULL),
(2, 00000023, 400524019, 019, '002500300023288', 'MAGAR ANANTA GAJANAN', 01, 'Y', 001, 10, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', 513696, 513696, 023288, '2017-04-17', 1, 0, '', '', '', NULL),
(3, 00000024, 400524019, 019, '002500310002803', 'JAI SHIV AMBE KRUPA COOP HSG SOC.LTD.', 01, 'Y', 001, 10, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', 513697, 513697, 002803, '2017-04-17', 1, 0, '', '', '', NULL),
(4, 00000025, 400524019, 019, '002500300030132', 'BHOIR NANDKUMAR RAMA', 01, 'Y', 001, 10, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', 513698, 513698, 030132, '2017-04-17', 1, 0, '', '', '', NULL),
(5, 00000026, 400524019, 019, '002500300023288', 'MAGAR ANANTA GAJANAN', 01, 'Y', 001, 10, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', 513699, 513699, 023288, '2017-04-17', 1, 0, '', '', '', NULL),
(6, 00000027, 400524019, 019, '002500310002803', 'JAI SHIV AMBE KRUPA COOP HSG SOC.LTD.', 01, 'Y', 001, 10, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', 513700, 513700, 002803, '2017-04-17', 1, 0, '', '', '', NULL);
...
(1, 00000025, 400524019, 019, '002500300030132', 'BHOIR NANDKUMAR RAMA', 01, 'Y', 001, 10, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', 513698, 513698, 030132, '2017-04-17', 1, 0, '', '', '', NULL),
(2, 00000026, 400524019, 019, '002500300023288', 'MAGAR ANANTA GAJANAN', 01, 'Y', 001, 10, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', 513699, 513699, 023288, '2017-04-17', 1, 0, '', '', '', NULL),
(3, 00000027, 400524019, 019, '002500310002803', 'JAI SHIV AMBE KRUPA COOP HSG SOC.LTD.', 01, 'Y', 001, 10, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', 513700, 513700, 002803, '2017-04-17', 1, 0, '', '', '', NULL),
(4, 00000025, 400524019, 019, '002500300030132', 'BHOIR NANDKUMAR RAMA', 01, 'Y', 001, 10, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', 513698, 513698, 030132, '2017-04-17', 1, 0, '', '', '', NULL),
(5, 00000026, 400524019, 019, '002500300023288', 'MAGAR ANANTA GAJANAN', 01, 'Y', 001, 10, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', 513699, 513699, 023288, '2017-04-17', 1, 0, '', '', '', NULL),
(6, 00000027, 400524019, 019, '002500310002803', 'JAI SHIV AMBE KRUPA COOP HSG SOC.LTD.', 01, 'Y', 001, 10, 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', 513700, 513700, 002803, '2017-04-17', 1, 0, '', '', '', NULL);
...
(1, 'SHIVAJI NAGAR', '410089', 'SHI001', 'SHI', 1, 1, 1, 0),
(2, 'THANE', '400601', 'THA001', 'THA', 1, 1, 2, 0),
(3, 'KALYAN', '421301', 'KAL001', 'KAL', 1, 1, 1, 1),
(4, 'KALYAN', '421301', 'KAL001', 'KLY', 1, 1, 3, 0);
