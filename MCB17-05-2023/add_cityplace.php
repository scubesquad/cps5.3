...
<?php include('includes.php'); ?>
	<script type="text/javascript">
		var vRules = { txtcityplace: { required:true }, ddlcountry: { required:true }, ddlstate: { required:true }};
		var vMessages = { txtcityplace: {required: "<br/>Please enter city place" },ddlcountry: {required: "<br/>Please select country" },ddlstate: {required: "<br/>Please select state" }};
...
<?php $rowcountry = $db->get_row("SELECT country FROM `tb_cps_settings`");?>
                <div id="formdiv">
					...
					<div id="formfields">
						<form name="addcountry" id="addcountry" action="post_cityplace.php?do=add" method="post">
									...
									<td align="left" valign="top" style="padding-left:16px; padding-top:16px; padding-bottom:16px">												
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												...
												<td width="85%" align="left" valign="top">
													<input type="text" name="txtcityplace" id="txtcityplace" style="width:183px" onKeyPress = "return isNumberKey1(event);" onKeyUp="javascript:this.value=this.value.toUpperCase();">										
												</td>
											</tr>
