		  ...
		  <tr>
				  ...
				  <tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						...
						<input type="text" name="branchname" id="branchname" value="<?php echo stripslashes($row->branch_name); ?>" style="width:379px;"  onKeyUp="javascript:this.value=this.value.toUpperCase();" />
					  </label></td>
					  </tr>
						<tr>
			  ...
			  <tr>
				...
				<tr>
				  ...
				  <tr>
					<td width="25%" height="35" align="left" valign="top"><label>Contact Person 1 Name</label></td>
					<td width="78%" align="left" valign="top">
						<label>
				...
				<tr>
					<td width="22%" height="35" align="left" valign="top"><label>Contact Person 1 Mobile No.</label></td>
					<td width="78%" align="left" valign="top">
						<label>
				...
				<tr>
					<td width="22%" height="35" align="left" valign="top"><label>Contact Person 1 Landline No.</label></td>
					<td width="78%" align="left" valign="top">
						<label>
				...
				<tr>
					<td width="22%" height="35" align="left" valign="top"><label>Contact Person 1 Email Id</label></td>
					<td width="78%" align="left" valign="top">
						<label>
				...
				<tr>
					<td width="22%" height="35" align="left" valign="top"><label>Contact Person 2 Name</label></td>
					<td width="78%" align="left" valign="top">
						<label>
				...
				<tr>
					<td width="22%" height="35" align="left" valign="top"><label>Contact Person 2 Mobile No.</label></td>
					<td width="78%" align="left" valign="top">
						<label>
				...
				<tr>
					<td width="22%" height="35" align="left" valign="top"><label>Contact Person 2 Landline No.</label></td>
					<td width="78%" align="left" valign="top">
						<label>
				...
				<tr>
					<td width="22%" height="35" align="left" valign="top"><label>Contact Person 2 Email Id</label></td>
					<td width="78%" align="left" valign="top">
						<label>
