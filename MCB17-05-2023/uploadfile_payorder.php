...
$(document).ready(function(){		
	...
	$( "#dialog-confirm" ).dialog({
			...
			buttons: {
				...
				Ok: function() {
					...
					window.location = 'post_payorder.php?do=print&pid='+selected_ids_array;		
				}
	...
	$( "#confirm-delete" ).dialog({
			...
			buttons: {
				...
				Ok: function() {
					window.location = 'post_payorder.php?do=delete&pid='+selected_ids_array;		
				}
			}
	});
...
$countnumber = 0;
if($totaldatainupload = $db->get_row("SELECT count(*) as total FROM tb_payorder_uploadingdata") ){
...
?>
				 ...
				 <table width="800" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
						<td align="left" valign="top">	
							<form id="frmuploadfile" name="frmuploadfile" enctype="multipart/form-data" action="post_payorder.php" method="POST">
								<table>
									<tr>
	...
	<!-- 						<div style="float:left;padding-right:15px;"><label>Account Type -</label>
							...
							<div style="float:left; padding-left:15px">
								<a href="uploadfile_payorder.php"><img src="images/refresh.png" alt="Refresh"></a>
							</div>
			...
			<tr>
				<td align="left" valign="top">
					...
					/*		if(!empty($_REQUEST['ddlAccountType']))
						...
						?>
						<?php 							
							echo "SELECT * FROM tb_payorder_uploadingdata where cps_unique_req not in (0)  $searchString";					
							if($result = $db->get_results("SELECT * FROM tb_payorder_uploadingdata where cps_unique_req not in (0)  $searchString")){
						...
						<?php 
								...
								<div style="color: darkred;margin-top: 10px;margin-bottom: 20px;border: 2px solid #dbdbdb;padding: 5px;text-align: center;">
						...
						<?php	}
							...
							{
								include_once 'post_payorder.php';
							}
