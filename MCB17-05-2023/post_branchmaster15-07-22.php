...
if(isset($_REQUEST['branchname']) && $_REQUEST['branchname'] != ""){	
		...
		$branch_clearingthrough = (isset($_REQUEST['radClearing']))?$_REQUEST['radClearing']:0;
		$branch_clearingcenter = (isset($_REQUEST['radClearingcentre']))?$_REQUEST['radClearingcentre']:0;
		$branch_clearingbankcode = (isset($_REQUEST['txtclrbankcode']))?$_REQUEST['txtclrbankcode']:0;
