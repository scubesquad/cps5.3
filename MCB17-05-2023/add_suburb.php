...
<?php include('includes.php'); ?>
	<script type="text/javascript">
		...
		var vMessages = { txtpostalcode: {required: "<br/>Please enter Postal code" },ddlcountry: {required: "<br/>Please select country" },ddlstate: {required: "<br/>Please select state" },ddlcity: {required: "<br/>Please select city" },txtsuburb: {required: "<br/>Please enter suburb" }};
