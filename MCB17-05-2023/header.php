...
<img src = "images/<?php echo $row_setting->banklogo; ?>" rel="" style="max-width: 50px;" />	<br/>
<?php endif;?>
Cheque Personalization System</div>
<div class="welcomeuser" style="float:right; margin-right:30px; margin-top:16px;    position: absolute;
    right: -20px;">Welcome <?php echo $_SESSION['admin_username']; ?></div>
