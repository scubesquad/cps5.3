...
if(isset($_REQUEST['ddlBranchName'])&&!empty($_REQUEST['ddlBranchName']))
{
  ...
  //  $sql = "(select cps_branchmicr_code,sum(cps_no_of_books) as cps_no_of_books,cps_tr_code,cps_book_size from tb_print_req_collection where chq_printed_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchString." GROUP BY cps_branchmicr_code,cps_tr_code,cps_book_size ORDER BY cps_branchmicr_code ASC,cps_tr_code,cps_tr_code ASC,cps_book_size ASC)";

 /*$sql = "SELECT  cps_branchmicr_code,SUM(cps_no_of_books) as cps_no_of_books,cps_tr_code,cps_book_size 
FROM ((select cps_branchmicr_code,SUM(cps_no_of_books) as cps_no_of_books,cps_tr_code,cps_book_size from tb_print_req_collection where chq_printed_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchString." GROUP BY ABS(cps_branchmicr_code),cps_tr_code,cps_book_size ORDER BY cps_branchmicr_code ASC,cps_tr_code ASC,cps_book_size ASC) UNION ALL (select cps_branchmicr_code,SUM(cps_no_of_books) as cps_no_of_books,cps_tr_code,cps_book_size from tb_payorder_req_collection where chq_printed_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchString." GROUP BY ABS(cps_branchmicr_code),cps_tr_code,cps_book_size ORDER BY cps_branchmicr_code ASC,cps_tr_code ASC,cps_book_size ASC)) report GROUP BY ABS(cps_branchmicr_code),cps_tr_code,cps_book_size ORDER BY ABS(cps_branchmicr_code) ASC,ABS(cps_tr_code) ASC,ABS(cps_book_size) ASC";*/
 $sql = "select branch_sub_code,SUM(cps_no_of_books) as cps_no_of_books,cps_tr_code,cps_book_size from tb_print_req_collection where chq_printed_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchString." GROUP BY ABS(branch_sub_code),cps_tr_code,cps_book_size ORDER BY ABS(branch_sub_code) ASC,ABS(cps_tr_code) ASC,ABS(cps_book_size) ASC";
   ...
   // $sqlbranch = "(select distinct ABS(cps_branchmicr_code) from tb_print_req_collection where chq_printed_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchString." ORDER BY cps_branchmicr_code ASC)";
     $sqlbranch = "select distinct ABS(branch_sub_code) as branch_sub_code from tb_print_req_collection where chq_printed_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchString." ORDER BY ABS(branch_sub_code) ASC";
...
if($resultbranch = $db->get_results($sqlbranch)){
  ...
  foreach ($resultbranch as $rowbranch) {
           ...
           /* $sql = "(select cps_branchmicr_code,sum(cps_no_of_books) as cps_no_of_books,cps_tr_code,cps_book_size from tb_print_req_collection where chq_printed_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchStringIndv." GROUP BY cps_branchmicr_code,cps_tr_code,cps_book_size ORDER BY cps_branchmicr_code ASC,cps_tr_code,cps_tr_code ASC,cps_book_size ASC)";*/

          /*   $sql = "SELECT  * 
FROM ((select cps_branchmicr_code,cps_no_of_books,cps_tr_code,cps_book_size from tb_print_req_collection where chq_printed_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchString." GROUP BY cps_branchmicr_code,cps_tr_code,cps_book_size ORDER BY cps_branchmicr_code ASC,cps_tr_code ASC,cps_book_size ASC) UNION ALL (select cps_branchmicr_code,cps_no_of_books,cps_tr_code,cps_book_size from tb_payorder_req_collection where chq_printed_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchString." GROUP BY cps_branchmicr_code,cps_tr_code,cps_book_size ORDER BY cps_branchmicr_code ASC,cps_tr_code ASC,cps_book_size ASC)) report ORDER BY ABS(cps_branchmicr_code) ASC,ABS(cps_tr_code) ASC,ABS(cps_book_size) ASC";*/

  $sql = "select branch_sub_code, ABS(cps_branchmicr_code) as cps_branchmicr_code,SUM(cps_no_of_books) as cps_no_of_books,cps_tr_code,cps_book_size from tb_print_req_collection where chq_printed_date between '".date('Y-m-d',strtotime($_REQUEST['from_date']))."' and '".date('Y-m-d', strtotime($_REQUEST['to_date']))."'".$searchStringIndv." GROUP BY ABS(branch_sub_code),cps_tr_code,cps_book_size ORDER BY ABS(branch_sub_code) ASC,ABS(cps_tr_code) ASC,ABS(cps_book_size) ASC";
