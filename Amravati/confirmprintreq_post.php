	...
	if($rowresults = $db->get_results("SELECT * FROM tb_printque ORDER BY cps_tr_code ASC"))
		{
			foreach($rowresults as $results)
			{
				...
				for($i=0;$i<$cps_no_of_books;$i++) {
					...
					/*echo "<br> FROM : ". $cps_chq_no_from;
					echo "<br> END : ". $cps_chq_no_to;
					echo "<br>";*/
