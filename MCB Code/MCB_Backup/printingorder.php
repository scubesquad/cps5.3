						...
						<td align="left" valign="top">	
							<form id="frmprn" name="frmprn">
								<table width="100%">
									...
									<tr id="ec_print_row">
										<td><label>Economy Print</label><span class="red">*</span></td>
										<td><input type="checkbox" id="ec_print" name="ec_print" /> </td>
									</tr>
									<tr>
									  <td>&nbsp;</td>
									</tr>
...
<script type="text/javascript">
	...
	function showCheques()
	{
		...
		// var arr_colors = ['#90cbe6', '#edffb4', '#ffbc78', 'cyan', 'darkgray'];
		var arr_colors = ['#90cbe6', '#edffb4', '#ffbc78', '#ffcccc', 'darkgray'];
		for(i = 0; i < n; i++)
		{
			r = $('#acn'+i).val();
			for(j = 1; j <= r; j++)
		...
		if($('#ec_print').attr('checked'))
		{
			...
			if($('#coloring_type').val() == 1)
				htmlcont += '<td style="padding: 10px; text-align: center;"> Page '+ i +'<table class="npage" width="100%"><tr><td style="background-color:darkgray" title="1st Leaf">' + lf1 + '</td></tr><tr><td title="2nd Leaf">' + lf2 + '</td></tr><tr><td style="background-color:#90cbe6; border: 1px dotted black" title="3rd Leaf">Blank</td></tr></table></td>';
			else
				htmlcont += '<td style="padding: 10px; text-align: center;"> Page '+ i +'<table class="npage" width="100%"><tr><td style="background-color:'+ lfcolor1 +'" title="1st Leaf">' + lf1 + '</td></tr><tr><td style="background-color:'+ lfcolor2 +'" title="2nd Leaf">' + lf2 + '</td></tr><tr><td title="3rd Leaf">Blank</td></tr></table></td>';
		}
		else
		{
			for(i = 1; i <= noofpages; i++)
	...
	$(document).ready(function () {
		...
		$('#ec_print').change(function (event) {
			var s = $('#dyndisplay').html();
			if(s && s.search('Please') == -1)
				showCheques();
		});		
