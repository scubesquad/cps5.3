...
if(isset($_REQUEST['type']) && !empty($_REQUEST['type']) && $_REQUEST['type'] == 'search'  && 
	 isset($_REQUEST['cust']) && !empty($_REQUEST['cust']) ) {
		$sql = "select * from tb_print_req_collection where cps_act_name LIKE '%".$_REQUEST['cust']."%' ";
}else{
...
if($result = $db->get_results($sql)){
						...
						$data = '<table cellpadding="3" cellspacing="0" border="1" width="93%">
                            <tr style="font-weight:bold; border:1px #cccccc">								
								<td width="20%" height="35px" class="thwidthth" align="center">Acc. No</td>
								<td width="20%" class="thwidthth" align="center">Name</td>								
								<td width="20%" class="thwidthth" align="center">Chq From</td>
								<td width="20%" class="thwidthth" align="center">Chq To</td>						
								<td width="20%" class="thwidthth" align="center">Date Of Issue</td>
                            </tr>' ;
