						    ...
						    <div id="formfields">
					    		...
					    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<!-- <tr style="visibility: hidden;">
							    		...
							    		<td width="50%" align="left"> -->
							    			<input type="hidden" name="txtFROM" id="txtFROM" value="000001" onKeyPress = "return isNumberKey(event);" />
							    		<!-- </td>
						    		</tr>
						    		<tr style="visibility: hidden;">
							    		...
							    		<td> -->
							    			<input type="hidden" name="txtTo" id="txtTo" value="999999" onKeyPress = "return isNumberKey(event);" />											
							    		<!-- </td>
						    		</tr> -->
						    		<tr >
							    		<td style="height: 35px; text-align: left">
