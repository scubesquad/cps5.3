...
<script type="text/javascript" src="scripts/dropdowntabs.js"></script>
	<script type="text/javascript">
		var vRules = { txtlastno: { required:true, maxlength:6 },txtFROM: { required:true, maxlength:6 },txtTo: { required:true, maxlength:6 }, ddlBranch: { required:true }, ddlBank: { required:true }, ddlTransactioncode: { required:true }};
		var vMessages = { txtlastno: { required: "<br/>Please enter last cheque series no.", maxlength:"<br/>Cheque series no must not exceed then {6} characters ."},txtFROM: { required: "<br/>Please enter cheque series starting no.", maxlength:"<br/>Cheque series no must not exceed then {6} characters ."},txtTo: { required: "<br/>Please enter cheque series ending no.", maxlength:"<br/>Cheque series no must not exceed then {6} characters ."},ddlBranch: {required: "<br/>Please select branch" },ddlBank: {required: "<br/>Please select bank" },ddlTransactioncode: {required: "<br/>Please select transaction code" } };
...
<?php require_once('header.php');?>
                <div id="formdiv">
                    ...
                    <div id="formfields">
                   <form id="frmchequeseries" name="frmchequeseries" enctype="multipart/form-data" action="post_chequeseries.php?todo=edit&id=<?php echo @$_REQUEST['id'];?>" method="POST" autocomplete="off">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
						  ...
						  <tr>
							...
							$sqlseries = "SELECT * FROM tb_cps_chequeseries WHERE series_id = ".GetSQLValueString($_REQUEST['id'],'int')."";
						    ...
						    <div id="formfields">                    				    	
					    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
									...
									<tr>
							    		...
							    		<td width="50%" align="left">							    			
											<select name="ddlBank" id="ddlBank" style="width:190px; height:26px;">
												...
												<?php if($banks->bank_id == $row_series->serise_Bank):?>
							    		...
							    		<td width="50%" align="left">
											<select name="ddlBranch" id="ddlBranch" style="width:190px; height:26px;">
												...
												<?php foreach($arrayBranch as $branch):?>
													<?php if($branch->branch_id == $row_series->series_branchcode):?>
						    		...
						    		<tr>
							    		...
							    		<td width="50%" align="left">
							    			<select name="ddlTransactioncode" id="ddlTransactioncode" style="width:190px; height:26px;">
												...
												<?php $arraytransactioncodes =  $db->get_results("SELECT * FROM tb_cps_transactioncodes "); ?>
												<?php foreach($arraytransactioncodes as $transactioncode): ?>
													<?php if($transactioncode->transactioncode == $row_series->series_transationcode):?>
														<option value="<?php echo $transactioncode->transactioncode; ?>" selected=selected><?php echo $transactioncode->transactioncode; ?></option>
													<?php else:?>	
									...
									<!-- <tr>
							    		...
							    		<td width="50%" align="left"> -->
							    			<input type="hidden" name="txtFROM" id="txtFROM" value="000001"  />
							    		<!-- </td>
						    		</tr>
						    		<tr>
							    		...
							    		<td> -->
							    			<input type="hidden" name="txtTo" id="txtTo" value="999999"  />											
							    		<!-- </td>
						    		</tr> -->
						    		<tr>
							    		<td style="height: 35px; text-align: left">
								...
								<div id="formfields">
                    				<table width="600px" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td style="height: 35px; text-align: left">
												<label>Error in request please <a href="manage_chequeseries.php">click here</a> to go back to cheque series.</label>
											</td>
										</tr>
									</table>
					    		</div>
