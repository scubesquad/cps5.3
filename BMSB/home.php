				...
				<table  style="width:100%;">
					<tr>
						<td style="width:100%;height:600px;">
							<?php
							$sql = "select desktop_image,homescreen_text from tb_cps_settings";
							$row_setting = $db->get_row($sql);	
							if($row_setting>0 && !empty($row_setting->homescreen_text))
							{
								echo "<h1 style='text-transform: uppercase;'>".$row_setting->homescreen_text."</h1>";
							}
							?>
							<!-- <img src = "images/<?php echo $row_setting->desktop_image; ?>" rel="" /> -->
						</td>
					</tr>
				</table>
			</div>
