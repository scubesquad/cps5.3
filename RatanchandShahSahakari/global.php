<?php session_start();	
	define('SITE_NAME','Ratanchand Shah Sahakari Bank');	
	// define("SITE_URL", "http://localhost:81");
	define("SITE_URL", "http://" . $_SERVER['HTTP_HOST']);
	// define("SITE_URL", 'http://192.168.0.36:81');
	define('SITE_ROOT', SITE_URL.'/RatanchandShahSahakari/');	
	define('SITE_ROOT_DOC','/RatanchandShahSahakari/');
...
error_reporting(E_ALL);
	...
	$user = 'root';
	$pass = '';	
	$name = 'db_ratanchand_shah_sahakari';
