...
<div id="formdiv">
	...
	<div id="formfields">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<?php if($result = $db->get_results("select * from tb_payorder_reprintque")): ?>
			<tr>
			<td align="center" valign="top" style="border:1px solid; border-color:#cccccc;">
				...
				<table cellpadding="0" cellspacing="0" border="0" width="1000" id="categorytable">
					...
					foreach($result as $row) :
						$sql1 = "select branch_name from tb_branchdetails where branch_code = ".$row->cps_branchmicr_code;
