		...
		<td colspan="2" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>      
				...
				<td width="89%" height="35" align="left" valign="top"><label>
					<input type="text" name="txtbankname" id="txtbankname" style="width:655px;" value="<?php echo stripslashes($row->bank_name); ?>" maxlength="40" onKeyPress="return isNumberKey1(event);" onKeyUp="javascript:this.value=this.value.toUpperCase();" />
					</label>
				</td>
			</tr>
		  </table>
