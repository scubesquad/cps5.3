...
$(document).ready(function(){		
	...
	$(".remove").click(function(){ 
		...
		$( "#dialog-remove" ).dialog({
				...
				buttons: {
					...
					Ok: function() {
						$.ajax({type: "POST", url: "post_chequeseries.php", dataType: 'json', data: "do=del&id="+tdid,
	...
	$( "#dialog-confirm" ).dialog({
			...
			buttons: {
				...
				Ok: function() {					
					$.ajax({type: "POST", url: "post_chequeseries.php", dataType: 'json', data: "do=del&cid="+selected_ids_array,
						success: function(resObj, statusText) {
							if(resObj.status) {							
								window.location = '<?php echo $_SERVER['REQUEST_URI']; ?>';					
							} else {
										...
										<form id="frmsearch" name="frmsearch" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
											<div class="searchdiv">
												...
												<div style="float:right">
													...
													<a href="add_chequeseries.php" class="formtitlehead" style="text-decoration:underline">Add New Cheque Series</a>&nbsp;															
													<?php endif;?>
												</div>															
											</div>														
										</form>														
														...
														<tbody>
															...
															?>
																<tr class="alternate" id="row_<?php echo $row->series_id; ?>" style="border-bottom:1px solid #ccc">
																    ...
																    <td style="border-bottom:1px solid #ccc" align="left" valign="middle" class="formtitle"><?php echo stripslashes($row->series_transationcode); ?></td>
																	...
																	<td style="border-bottom:1px solid #ccc" align="center" valign="middle">          																																
																		<a href="<?php echo ADMIN_ROOT; ?>edit_chequeseries.php?todo=edit&id=<?php echo $row->series_id; ?>"><img src="<?php echo ADMIN_IMAGES; ?>icon_edit.png" title="Edit" border="0" /></a>
