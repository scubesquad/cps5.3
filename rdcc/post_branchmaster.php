...
if(isset($_REQUEST['branchname']) && $_REQUEST['branchname'] != "")
{
	...
	$branch_master_id = $_REQUEST['branch_master_id'];
	...
	$branchmicr = $_REQUEST['branchmicr'];
...
// ===================================================== update query ===================================================
	...
	else
	{
		...
		$sql = "INSERT INTO tb_branchdetails
				(branch_master_id,branch_name,branch_code,branch_address1,branch_address2,branch_address3,branch_country_id,branch_state_id,branch_city_id,branch_suburb_id,branch_pin,branch_telephone1,branch_telephone2,branch_contactperson1,branch_contactperson2,branch_contactpersonmobile1,branch_contactpersonmobile2,branch_email1,branch_email2,branch_micr,branch_atparmicrcode,branch_neftifsccode,branch_clearingthrough,branch_clearingcenter,clr_bank_code,clr_bank_city,branch_City_Code,branch_Services, branch_reg_busi_hrs,branch_half_busi_hrs,branch_sunday_working,branch_tollfree_no)     
				VALUES
				('".$branch_master_id."','".$branchname."','".$branchcode."','".$branchaddress1."','".$branchaddress2."','".$branchaddress3."','".$branchcountry."','".$branchstate."','".$branchcity."','".$branchsuburb."','".$branchpin."','".$branchtelephone1."','".$branchtelephone2."','".$branchcontper1."','".$branchcontper2."','".$branchmobilecontper1."','".$branchmobilecontper2."','".$branchemail1."','".$branchemail2."','".$branchmicr."','".$branchatpermicr."','".$branchNEFT."','".$branch_clearingthrough."','".$branch_clearingcenter."','".$branch_clearingbankcode."','".$branch_clearingcitycenter."','".$cityCode."','".$branchServices."','".$branchregbusihrs."','".$branchhalfbusihrs."','".$branchsundayworking."','".$branchtollfreeno."')";
