								...
								<select name="ddlBranchName" id="ddlBranchName" style="width:198px; height:26px;">
									...
									<?php 
										...
										foreach($rowgetbranch as $eachbranch){
											...
											{
												?><option class="brn" value="<?php echo $eachbranch->branch_code; ?>" selected="selected"><?php echo $eachbranch->branch_name; ?></option><?php
											}
											else
											{
												?><option class="brn" value="<?php echo $eachbranch->branch_code; ?>"><?php echo $eachbranch->branch_name; ?></option><?php
											} 
										} 
									?>
								</select>
