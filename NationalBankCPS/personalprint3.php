...
<form id="frmuploadfile" name="frmuploadfile"
    enctype="multipart/form-data" action="personalprint3_post.php"
    method="POST">
                ...
                <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="3000">
                        <tr>
                            ...
                            <th class="thwidthth">Chk From</th>
                            <th class="thwidthth">Chk To</th>
                        ...
                        <?php
if ($result = $db->get_results("select * from tb_pending_print_req where cps_isprint = 1 and cps_unique_req = 0")) {
