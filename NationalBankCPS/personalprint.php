...
<link rel="stylesheet" href="<?php echo ROOT_STYLES; ?>jquery.timepicker.css" type="text/css">
    <script type="text/javascript">
        var vRules = {ddlBranchName: { required:true },bankCode: { required:true },branchCode: { required:true },cityCode: { required:true },ddlAccountType: { required:true },noOfBooks: { required:true },bookSize: { required:true },address1: { required:true },ddlcountry: { required:true }, city: { required:true }, pin: { required:true }, Bearer_Order: { required:true }};
        var vMessages = { ddlBranchName: {required: "<br/>Please select branch name" }, bankCode: { required: "<br/>Please enter bank code."}, branchCode: { required: "<br/>Please enter branch code."}, cityCode: { required: "<br/>Please enter city code" }, ddlAccountType: { required: "<br/>Please select account type"},noOfBooks: {required: "<br/>Please enter no of books" }, bookSize: { required: "<br/>Please enter book size"},address1: { required: "<br/>Please enter address"}, city: {required: "<br/>Please enter city" }, pin: {required: "<br/>Please enter pin" },Bearer_Order: {required: "<br/>Please enter Bearer/Order" } };
    ...
    function showchkno(showval){
        if(showval == "12"){
            ...
            //document.getElementById("custACNo").readOnly=true;
            //document.getElementById("custName").readOnly=true;
            //document.getElementById("jointName1").readOnly=true;
            //document.getElementById("signAuth1").readOnly=true;
        }
        else{
            document.getElementById("divchkno").style.display = "block";
            document.getElementById("custACNo").readOnly=false;
            document.getElementById("custName").readOnly=false;
            document.getElementById("jointName1").readOnly=false;
            document.getElementById("signAuth1").readOnly=false;
        }
    }
                        ...
                        <td align="left" valign="top" width="80%">
                            <label>
                                <select name="ddlBranchName" id="ddlBranchName" style="width:198px; height:26px;" onchange="showBranchCityCode(this.value)">
                                        ...
                                        <?php
$rowgetbranch = $db->get_results("select branch_id,branch_name from tb_branchdetails order by branch_name asc");
...
?>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top" width="80%">
                            <label>
                                <input type="text" maxlength="3" value="<?php echo "" . $rowbank->bank_code . ""; ?>" readonly="true" name="bankCode" id="bankCode" style="width:190px;" />
                            </label>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top" width="80%">
                            <div id="divBranchCode" >
                                <label>
                                    <input type="text" maxlength="3" value="" readonly="true" name="branchCode" id="branchCode" style="width:190px;" />
                                </label>
                            </div>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top" width="80%">
                            <div id="divCityCode" >
                                <label>
                                    <input type="text" maxlength="3" value="" readonly="true" name="cityCode" id="cityCode" style="width:190px;" />
                                </label>
                            </div>
                        </td>
                      </tr>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" width="80%">
                        <label>
                            <select name="ddlAccountType" id="ddlAccountType" style="width:198px; height:26px;" onChange="showchkno(this.value)">
...
?>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td align="left" valign="top" width="83%">
                                            <input type="text" name="txtchqnofrom" id="txtchqnofrom" value="" style="width: 220px;" maxlength="6" onkeypress="return isNumberKey(event)"  />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" valign="top" width="17%" height="35px">
                                        ...
                                        <td align="left" valign="top" width="83%">
                                            <input type="text" name="txtchqnoto" id="txtchqnoto" value="" style="width: 220px;" maxlength="6" onkeypress="return isNumberKey(event)" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" width="80%">
                            <label>
                                <input type="text" value="" name="custACNo" id="custACNo" style="width:190px;" onkeypress="return isNumberKey(event)" />
                            </label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td height="35" align="left" valign="top" width="20%"><label>Atpar</label>
                        </td>
                        <td align="left" valign="top" width="80%">
                            <label>
                                <input type="text" value="" name="atpar" id="atpar" style="width:190px;" onKeyUp="javascript:this.value=this.value.toUpperCase();" />
                            </label>
                        </td>
                    </tr>
              ...
              <tr>
                ...
                <tr>
                    ...
                    <td width="78%" align="left" valign="top">
                        <label>
                            <input type="text" name="custName" id="custName"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="50" />
                        </label>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="78%" align="left" valign="top">
                        <label>
                            <input type="text" name="jointName1" id="jointName1"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="50" />
                ...
                <tr>
                    ...
                    <td width="78%" align="left" valign="top">
                        <label>
                            <input type="text" name="jointName2" id="jointName2"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="50" />
                ...
                <tr>
                    ...
                    <td width="78%" align="left" valign="top">
                        <label>
                            <input type="text" name="signAuth1" id="signAuth1"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="50" />&nbsp;<label>
                ...
                <tr>
                    <td width="22%" height="35" align="left" valign="top"><label>Address Line4</label></td>
                    <td width="78%" align="left" valign="top">
                        <label>
                            <input type="text" name="branchaddress4" id="branchaddress4"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="35" />&nbsp;<label>(35 characters)</label>
                ...
                <tr>
                    <td width="22%" height="35" align="left" valign="top"><label>Address Line5</label></td>
                    <td width="78%" align="left" valign="top">
                        <label>
                            <input type="text" name="branchaddress5" id="branchaddress5"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="35" />&nbsp;<label>(35 characters)</label>
