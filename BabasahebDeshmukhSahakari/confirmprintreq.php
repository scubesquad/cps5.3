		...
		<table width="969" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" border="0" width="3000" id="categorytable">
					...
					<?php }}?>
					<tr>
						<td class="thwidthth" colspan="23" style="text-align:left; padding-left:30px; height:40px;">
						<input type="submit" id="btnprint" name="btnprint" value="Print All" style="padding: 5px;"></input> <!-- <span>|</span> -->
					<!-- 	 <a id="mark_all" style="margin-right:10px; border: 1px solid rgb(118, 118, 118);
    padding: 5px 3px 5px 3px;
    border-radius: 5px;" class="pointer"  onclick="MarkAll();" >Select all</a>
          <a id="unmark_all" style="margin-right:10px; border: 1px solid rgb(118, 118, 118);
    padding: 5px 3px 5px 3px;
    border-radius: 5px;" class="pointer"  onclick="Unmark_all();">Deselect all</a> -->
						<a id="cancel_selected" style="margin-right: 10px;
    border: 1px solid rgb(118, 118, 118);
    padding: 5px 3px 5px 3px;
    border-radius: 5px; margin-left: 20px;" class="pointer" onclick="Cancel_selected();">Cancel Selected</a>
