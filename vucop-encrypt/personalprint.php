			  ...
			  <tr>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="custName" id="custName"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="65" />			
						</label>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="signAuth1" id="signAuth1"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="300" />&nbsp;<label>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="signAuth2" id="signAuth2"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="300" />&nbsp;<label>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="signAuth3" id="signAuth3"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="300" />
