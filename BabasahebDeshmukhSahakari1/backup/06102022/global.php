<?php session_start();	
	define('SITE_NAME','Babasaheb Deshmukh Sahakari Bank');	
	// define("SITE_URL", "http://localhost:81");
	define("SITE_URL", "http://" . $_SERVER['HTTP_HOST']);
	// define("SITE_URL", 'http://192.168.0.36:81');
	define('SITE_ROOT', SITE_URL.'/BabasahebDeshmukhSahakari/');	
	define('SITE_ROOT_DOC','/BabasahebDeshmukhSahakari/');
...
error_reporting(E_ALL);
	...
	$user = 'root';
	$pass = '';	
	$name = 'db_babasaheb_deshmukh_sahakari';
