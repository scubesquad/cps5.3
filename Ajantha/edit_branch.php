					  ...
					  <tr>
						...
						<td align="left" valign="top" width="80%">
					  	...
					  	<tr>
						   ...
						   <td align="left" valign="top" width="80%">
						      <label>
						      <input type="text" value="<?php echo stripslashes($row->branch_micr); ?>" name="branchmirc" id="branchmirc" maxlength="9" minlength="9" style="width:190px;" onKeyUp="javascript:this.value=this.value.toUpperCase();" />
						      </label>
						   </td>
						</tr>
			  ...
			  <tr>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="branchaddress1" id="branchaddress1"  style="width:300px;" value="<?php echo stripslashes($row->branch_address1); ?>" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="85" />&nbsp;<label>(85 characters)</label>
