...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 25, 2022 at 01:41 PM
...
(0001, 'ASHOK SHAKARI BANK LTD., AHMEDNAGAR', 815, 'KOTHI ROAD, MARKET YARD RD', '', '', 1, 2, 1, 1, '444803', '', '', '', '', 0, 0, '', '', '', 'a:1:{i:0;a:3:{i:0;s:36:\"HP LaserJet Pro M402-M403 n-dn PCL 6\";i:1;s:6:\"Tray 1\";i:2;s:6:\"Tray 2\";}}');
...
INSERT INTO `tb_branchdetails` (`branch_id`, `branch_code`, `branch_sub_code`, `branch_name`, `branch_micr`, `branch_atparmicrcode`, `branch_address1`, `branch_address2`, `branch_address3`, `branch_country_id`, `branch_state_id`, `branch_city_id`, `branch_suburb_id`, `branch_pin`, `branch_telephone1`, `branch_telephone2`, `branch_contactperson1`, `branch_contactperson2`, `branch_contactpersonmobile1`, `branch_contactpersonmobile2`, `branch_email1`, `branch_email2`, `branch_holiday`, `branch_neftifsccode`, `branch_printers`, `branch_working_hours`, `branch_clearingthrough`, `branch_clearingcenter`, `clr_bank_code`, `clr_bank_city`, `branch_City_Code`, `branch_Services`, `branch_reg_busi_hrs`, `branch_half_busi_hrs`, `branch_sunday_working`, `branch_tollfree_no`) VALUES
(1, '001', '005', 'AHMEDNAGAR BRANCH', '', '', ' KOTHI ROAD, MARKET YARD', '', '', 1, 2, 1, 1, 414001, '', '', '', '', '', '', '', '', NULL, 'ICIC00ASHSB', NULL, NULL, 0, 0, '', 0, 414, '', '', '', '', ''),
(3, '301', '001', 'SHRIRAMPUR BRANCH', '', '', ' KOTHI ROAD, MARKET YARD', '', '', 1, 2, 1, 1, 414001, '', '', '', '', '', '', '', '', NULL, 'ICIC00ASHSB', NULL, NULL, 0, 0, '', 0, 414, '', '', '', '', ''),
(4, '002', '004', 'WAGHOLI BRANCH', '', '', ' KOTHI ROAD, MARKET YARD', '', '', 1, 2, 1, 1, 414001, '', '', '', '', '', '', '', '', NULL, 'ICIC00ASHSB', NULL, NULL, 0, 0, '', 0, 414, '', '', '', '', ''),
(5, '501', '002', 'ASHOK NAGAR BRANCH', '', '', ' KOTHI ROAD, MARKET YARD', '', '', 1, 2, 1, 1, 414001, '', '', '', '', '', '', '', '', NULL, 'ICIC00ASHSB', NULL, NULL, 0, 0, '', 0, 414, '', '', '', '', ''),
(6, '501', '003', 'ALE PHATA BRANCH', '', '', ' KOTHI ROAD, MARKET YARD', '', '', 1, 2, 1, 1, 414001, '', '', '', '', '', '', '', '', NULL, 'ICIC00ASHSB', NULL, NULL, 0, 0, '', 0, 414, '', '', '', '', '');
...
(001, 'AHM001', 'AHMEDNAGAR', 'AMR', 1, 2, 0);
...
(1, 10, 1, 1, 400000, 500000, 401930, 1, '005'),
(3, 10, 3, 301, 000001, 999999, 000001, 1, '001');
...
CREATE TABLE IF NOT EXISTS `tb_cps_reprintque` (
  ...
  `cps_act_name` varchar(55) DEFAULT NULL,
  ...
  `cps_act_jointname1` varchar(55) DEFAULT NULL,
  `cps_act_jointname2` varchar(55) DEFAULT NULL,
  ...
  `cps_product_code` varchar(6) DEFAULT NULL,
  `branch_sub_code` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(2, 00002418, 413909501, 501, '002010100009640', 'RATHOD RAMLAL BHAVLAL', 1, 'Y', 15, 10, '', '', '', '', '', '', 'A P BHAMBARWADI', 'TAL KANNAD', 'DIST AURANGABAD', '', '', 'SHRIRAMPUR', '', '', '', 431103, '', '', '9890634204', '', 100061, 100075, 009640, '2022-08-24', 1, NULL, NULL, 0, '', '101000', '002');
...
('', 'uploads/', 'Excel', '', '', 'Excel', '', '', 0, 1, 000000, 000000, 9, 365, 'ASHOK SHAKARI BANK LTD., AHMEDNAGAR', 'DevHarsh Infotech Pvt Ltd', 'thane logo.jpg', 'Penguins.jpg', '', '', '', '', '', 360, '', '', '', '0000-00-00', 0, '0000-00-00', 0, 0, 0, 0);
...
('admin', '21232f297a57a5a743894a0e4a801fc3', '2012-04-21 00:00:00', 1, 0, 0, 1, 0, 'admin', '2022-07-29', 1),
('reprint', '21232f297a57a5a743894a0e4a801fc3', '2015-05-31 00:00:00', 16, 0, 0, 1, 1, 'reprint', '2022-07-29', 1);
...
(2, 00006163, 413815301, 301, '001010100002326', 'ABASAHEB U AHER', 01, 'Y', 015, 10, '', '', '', '', '', '', 'A  P  TAKLIBHAN TAL  SHRIRAMPUR', '', '', '', '', 'SHRIRAMPUR', '', '', '', 413709, '', '', '95112188969', '', 100046, 100060, 002326, '2022-08-23', 1, 0, '', '', '', '101000', '001'),
(3, 00002418, 413909501, 501, '002010100009640', 'RATHOD RAMLAL BHAVLAL', 01, 'Y', 015, 10, '', '', '', '', '', '', 'A P BHAMBARWADI', 'TAL KANNAD', 'DIST AURANGABAD', '', '', 'SHRIRAMPUR', '', '', '', 431103, '', '', '9890634204', '', 100061, 100075, 009640, '2022-08-24', 1, 0, '', '', '', '101000', '002'),
(4, 00006164, 413815301, 301, '001011200000602', 'VINAYAK MEDICAL & GENERAL STORES', 01, 'Y', 090, 11, '', '', '', '', '', '', 'A P NIWARA HSG SHRIRAMPUR', '', ' ', '', '', 'SHRIRAMPUR', '', '', '', 0, '', '', '', '', 201711, 201800, 000602, '2022-08-24', 1, 0, '', '', '', '101101', '001'),
(5, 00006165, 413815301, 301, '001011200000755', 'KEVAL KIRANA', 01, 'Y', 030, 11, '', '', '', '', '', '', 'BELAPUR ROAD SHRIRAMPUR', 'A P SHRIRAMPUR', 'DIST AHMEDNAGAR', '', '', 'SHRIRAMPUR', '', '', '', 413709, '', '', '9960242171', '', 200286, 200315, 000755, '2022-08-24', 1, 0, '', '', '', '101101', '001'),
(6, 00002419, 413909501, 501, '002010100010998', 'RATHOD ANUSAYABAI HARACHND', 01, 'Y', 015, 10, '', '', '', '', '', '', 'VASANT NAGAR', 'JATEGAON', 'NASHIK', '', '', '', '', '', '', 423106, '', '', '', '', 100001, 100015, 010998, '2022-08-24', 1, 0, '', '', '', '101000', '002'),
(7, 00003192, 411909002, 002, '004011200000104', 'SATAV ELECTRICALS & ELECTRONICS-PROP.SATAV PANDURA', 01, 'Y', 030, 11, '', '', '', 'Proprietor', '', '', 'A P WAGHOLI TAL HAVELI DIST PUNE', 'PUNE', '', '', '', 'PUNE', '', '', '', 412207, '', '', '8888386691', '', 200226, 200255, 000104, '2022-08-24', 1, 0, '', '', '', '101101', '004');
...
(15, 00006163, 413815301, 301, '001010100002326', 'ABASAHEB U AHER', 01, 'Y', 015, 10, '', '', '', '', '', '', 'A  P  TAKLIBHAN TAL  SHRIRAMPUR', '', '', '', '', 'SHRIRAMPUR', '', '', '', 413709, '', '', '95112188969', '', 100046, 100060, 002326, '2022-08-23', 16, 0, '', '', NULL, '101000', '001');
...
(1, 'AHMEDNAGAR', '414001', 'AHM001', 'AMR', 1, 2, 1, 0);
...
CREATE TABLE IF NOT EXISTS `tb_uploadingdata` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `cps_unique_req` bigint(12) UNSIGNED ZEROFILL NOT NULL,
