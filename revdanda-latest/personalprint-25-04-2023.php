...
<script type="text/javascript">
	...
	function checkTransactionType(obj){
		...
		if($(obj).val()==12){
			 $("#custACNo").rules("remove", "required");
			$('#custACNoReq').hide();
			  ...
			  <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
					...
					<tr id="divAccScream" style="display:none">
						<td height="35" align="left" valign="top" width="20%">
							<label>Cash Credit Account Scream</label>
						</td>
						<td align="left" valign="top" width="80%">
							<label>
								<input type="text" name="custAccScream" id="custAccScream" style="width:190px;" maxlength="20"/>
							</label>
						</td>
					</tr>
					...
					<tr id="divCustAcc">
						<td height="35" align="left" valign="top" width="20%"><label>Customer A/C No.</label><span class="red" id="custACNoReq">*</span>
						</td>
						<td align="left" valign="top" width="80%">
							<label>
								<input type="text" name="custACNo" id="custACNo" style="width:190px;" maxlength="20" onblur="fetchAccountDetails()"/>
							</label>
						</td>
					</tr>
					<tr>
						...
						<td align="left" valign="top" width="80%">
							<label>
								<input type="text" name="mircACNo" id="mircACNo" style="width:190px;" maxlength="6" onkeypress="return isNumberKey(event)" />
							</label>
						</td>
					</tr>
					...
					<tr>
						...
						<td align="left" valign="top" width="80%">
							<label>
								<input type="text" name="noOfBooks" id="noOfBooks" style="width:190px;" maxlength="2" onkeypress="return isNumberKey(event)" />
							</label>
						</td>
					</tr>
					...
					<tr>
						...
						<td align="left" valign="top" width="80%">
							<label>
								<input type="text" name="bookSize" id="bookSize" style="width:190px;" maxlength="3" onkeypress="return isNumberKey(event)" />
							</label>
						</td>
					</tr>
			  ...
			  <tr>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="custName" id="custName"  style="width:300px;" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="65" />			
						</label>
					</td>
				</tr>
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="custShortName" id="custShortName"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="65" />			
						</label>
					</td>
				</tr>				
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="jointName1" id="jointName1"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="200" />
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="jointName2" id="jointName2"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="200" />
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="signAuth1" id="signAuth1"  style="width:300px;" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="200" />&nbsp;<label>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="signAuth2" id="signAuth2"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="200" />&nbsp;<label>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="signAuth3" id="signAuth3"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="200" />
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="address1" id="address1"  style="width:300px;" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="35" />&nbsp;<label>(35 characters)</label>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="address2" id="address2"  style="width:300px;" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="35" />&nbsp;<label>(35 characters)</label>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="branchaddress3" id="branchaddress3"  style="width:300px;" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="35" />&nbsp;<label>(35 characters)</label>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">						
						<input type="text" name="city" id="city" style="width:190px;" />							
					</td>
				</tr>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">						
						<input type="text" name="pin" id="pin" style="width:190px;" />							
					</td>
				</tr>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							+91<input type="text" name="custMobNo" id="custMobNo" maxlength="15" onkeypress="return isNumberKey(event)" style="width:167px;" />
						</label>
					</td>
				</tr> 
...
<!--				-->
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="custEmailId" id="custEmailId" style="width:190px;" />
						</label>
					</td>
				</tr>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#ddlAccountType').change(function(){
			let val = $(this).val();
			if(val == 13){
				$('#divAccScream').css('display', 'revert');
			}else{
				$('#divAccScream').css('display', 'none');
				$('#custAccScream').val('');
			}
		})
	})
