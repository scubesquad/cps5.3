			...
			<tr>
			  ...
			  <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
					...
					<tr id="idAccScream" style="display:none">
						<td height="35" align="left" valign="top" width="20%">
							<label>Cash Credit Account Scream</label>
						</td>
						<td align="left" valign="top" width="80%">
							<label>
								<input type="text" name="accScream" id="accScream" style="width:190px;" maxlength="5" />
							</label>
						</td>
					</tr>
			  ...
			  <tr>
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="jointName1" id="jointName1"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="65" />
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="jointName2" id="jointName2"  style="width:300px;" value="" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="65" />
				...
				<tr>
					...
					<td width="78%" align="left" valign="top">
						<label>
							<input type="text" name="signAuth1" id="signAuth1"  style="width:300px;" onKeyUp="javascript:this.value=this.value.toUpperCase();" maxlength="35" />&nbsp;<label>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#ddlAccountType').change(function(){
			...
			if(accType == "13"){
				$('#idAccScream').css('display', 'revert');
			}else{
				$('#idAccScream').css('display', 'none');
				$('#accScream').val('');
			}
		})
	})
